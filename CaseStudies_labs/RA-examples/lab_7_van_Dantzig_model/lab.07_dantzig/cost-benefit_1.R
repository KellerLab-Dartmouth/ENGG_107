...
######################################################
##  authors: Ryan Sriver and Klaus Keller (rsriver@psu.edu)
##  copyright by the authors
##  distributed under the GNU general public license
##  no warranty
##################################################
# version: 2, last changes: March 12, 2012 by rls
##################################################
# how to run:
# - save the file in a directory
# - go to the directory with this file
# - open R
# - type 'source(cost-benefit.R)'
...
cex=1.5,ylim=c(0,5e-3), xlim=c(0,10),
...
abline(v=3.8,lwd=3,col="black",lty="dashed")
abline(v=X[min_ind],lwd=3,col="blue",lty="dashed")
abline(h=1e-6,lwd=3,col="green",lty="dashed")

legend(x="topright",
       inset=c(0.1,0.1),
       legend=c("Exponential Model","1953 Flood","minimum cost","minimum risk"),
